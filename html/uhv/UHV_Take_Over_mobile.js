...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("", "48px 'CircularXX-Regular'", "#FFFFFF");
	this.text.lineHeight = 44;
	this.text.lineWidth = 100;
	this.text.parent = this;
	this.text.setTransform(249,571.25);

	this.text2test = new cjs.Text("Metoderna, \nverktygen och allt annat \nsom rör \nupphandling.", 
		"44px 'CircularXX-Medium'",
  "#FFFFFF"
);
	this.text2test.name = "text2test";
	this.text2test.lineHeight = 44;
	this.text2test.lineWidth = 293;
	this.text2test.parent = this;
	this.text2test.setTransform(2,2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text2test},{t:this.text}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Text3MC_Link, new cjs.Rectangle(0,0,351,632.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text1test = new cjs.Text("Så gör du \nbättre upp-\nhandlingar.", 
		"53px 'CircularXX-Black'",
  "#FFFFFF"
);
	this.text1test.name = "text1test";
	this.text1test.lineHeight = 53;
	this.text1test.lineWidth = 308;
	this.text1test.parent = this;
	this.text1test.setTransform(-116.6,-115.75);

	this.timeline.addTween(cjs.Tween.get(this.text1test).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.TestSymbol1, new cjs.Rectangle(-118.6,-117.7,312.4,298.8), null);
...
// stage content:
(lib.UHV_Take_Over_mobile = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function loopTexts(scope) {
		    // 🔸 Låt text1 vara synlig i 3 sek, sen fada ut
		    createjs.Tween.get(scope.text1)
		        .wait(3000)
		        .to({ alpha: 0 }, 1000)
		        .call(() => {
		            console.log("text1 ut");
		            ...
		            createjs.Tween.get(scope.text2)
		                .to({ alpha: 1 }, 1000)
		                .call(() => {
		                    console.log("text2 in");
		
		                    // 🔸 Efter 2 sek: text3 fade in
		                    createjs.Tween.get(scope.text3)
		                        .wait(2000)
		                        .to({ alpha: 1 }, 1000)
		                        .wait(3000) // bägge ligger kvar
		                        .to({ alpha: 0 }, 1000)
		                        .call(() => {
		                            console.log("text3 ut");
		                        });
		
		                    // 🔸 Text2 fade out i sync med text3
		                    createjs.Tween.get(scope.text2)
		                        .wait(6000)
		                        .to({ alpha: 0 }, 1000)
		                        .call(() => {
		                            console.log("text2 ut");
		                            ...
		                            createjs.Tween.get(scope.text1)
		                                .to({ alpha: 1 }, 1000)
		                                .call(() => {
		                                    console.log("text1 tillbaka – loopar om");
		                                    loopTexts(scope); // 🔁 starta om
		                                });
		                        });
		                });
		        });
		...
		var img = new Image();
		img.src = "https://cdn.jsdelivr.net/gh/thechineseroom/banner_assets/images/bg_uhv2_mob.jpg";
		...
		function laddaLoggor(scope) {
		    const loggor = [
		        {
		            url: "https://cdn.jsdelivr.net/gh/thechineseroom/banner_assets/images/byggforetagen_logo_small.png",
		            x: 12,
		            y: 440
		        },
		        {
		            url: "https://cdn.jsdelivr.net/gh/thechineseroom/banner_assets/images/bkma_logo_small.png",
		            x: 12,
		            y: 390 // t.ex. 20 pixlar längre ner
		        }
		    ];
	...
	this.clickArea.setTransform(82.45,540.3,0.3229,1.92,0,0,0,255.3,281.4);
	new cjs.ButtonHelper(this.clickArea, 0, 1, 1);

		this.text3 = new cjs.Text("Läs mer på: \nbyggforetagen.se", 
		"33px 'CircularXX-Medium'",
  "#FFFFFF"
);
	this.text3.name = "text3";
	this.text3.lineHeight = 33;
	this.text3.lineWidth = 295;
	this.text3.parent = this;
	this.text3.setTransform(11.4,287.1);
	...
	this.text2.setTransform(183.4,70.3,1,1,0,0,0,174,30.1);
...
p.nominalBounds = new cjs.Rectangle(160,240,2212.3,840);
// library properties:
lib.properties = {
